...
class Portalfsn(CustomerPortal):
    ...
    def fsn_sign(
        ...
        try:
            ...
            fsn_sudo.document_signed = log.attach_signature_to_pdf(fsn_sudo.document_signed, request.env.user.sign_signature, log.approval_type, log.x_coord, log.y_coord)
