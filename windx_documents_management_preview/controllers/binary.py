...
class Binary(http.Controller):
    ...
    @http.route(['/get/attachment/details'], type='json', auth="public", methods=['POST'], website=True)
    def get_attachment_data(self, res_id=False, model=False, size=False, res_field=False, **kw):
        """
